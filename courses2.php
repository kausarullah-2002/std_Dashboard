            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <section class="course-section course-information" > <h2> Course Information</h2>
                        ...
                        <form action="coursedata.php" method="POST" enctype="multipart/form-data">
                            <select id="program" name="dbUpload" >
                              <option value="program1">Program 1</option>
                              <option value="program2">Program 2</option>
                              <option value="program3">Program 3</option>
                            </select>
                          
                            <select id="campus" name="campusName">
                              <option value="campus1">Campus 1</option>
                              <option value="campus2">Campus 2</option>
                              <option value="campus3">Campus 3</option>
                            </select>
                            <a href="courses3.html"><button class="enroll btn btn-primary" type="submit" name="save_select" value="Enroll">Enroll</button></a>
